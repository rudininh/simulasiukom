...
PROMPT;
    ...
    private function specialPrompt(string $categoryCode, string $text, string $category, int $count, string $difficulty, string $questionType, ?string $keywords): ?string
    {
        $focus = match ($categoryCode) {
            ...
            'MANAJEMEN_ASN' => "- Perencanaan kebutuhan ASN\n- Pengadaan ASN\n- Pangkat dan jabatan\n- Pengembangan karier\n- Promosi dan mutasi\n- Manajemen kinerja\n- Disiplin ASN\n- Pemberhentian dan pensiun\n- Cuti ASN",
            'KINERJA_KOMPETENSI_ASN' => "- Pengelolaan kinerja pegawai ASN\n- Sasaran kinerja pegawai\n- Dialog kinerja\n- Umpan balik kinerja\n- Evaluasi kinerja\n- Standar Kompetensi Jabatan ASN\n- Pengembangan kompetensi PNS dan PPPK",
            'KEPEMIMPINAN_MANAJERIAL' => "- Kompetensi manajerial\n- Pengambilan keputusan\n- Koordinasi lintas unit\n- Manajemen perubahan\n- Komunikasi birokrasi\n- Pengendalian kinerja tim\n- Integritas kepemimpinan\n- Studi kasus jabatan manajerial",
            'PELAYANAN_PUBLIK_ETIKA' => "- Standar pelayanan publik\n- Hak dan kewajiban penyelenggara pelayanan\n- Pengaduan masyarakat\n- Etika birokrasi\n- Transparansi dan akuntabilitas\n- Administrasi pemerintahan\n- Keterbukaan informasi publik",
            'DISIPLIN_ETIKA_NETRALITAS' => "- Kewajiban PNS\n- Larangan PNS\n- Hukuman disiplin\n- Prosedur pemeriksaan disiplin\n- Kode etik PNS\n- Netralitas ASN\n- Penyelenggaraan negara bebas KKN",
