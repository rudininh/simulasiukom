...
<div class="cat-card p-3 mb-3">
    <form class="row g-2">
        ...
        <div class="col-md-1"><select class="form-select" name="difficulty"><option value="">Sulit</option>@foreach(['easy','medium','hard','case'] as $difficulty)<option @selected(request('difficulty')===$difficulty)>{{ $difficulty }}</option>@endforeach</select></div>
